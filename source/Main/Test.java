...
//                    "Adrioni", 9.0, dateFormat.parse("2022-12-4"), 12.0, 16.0, "OSHO", 8, "images/Me_ty_Pa_ty.png",0);
...
//                    "Money Bookstore", 18.0, dateFormat.parse("2024-01-14"), 22.0, 28.0, "Fyodor Dostoevsky", 5, "images/crimeandpunishment.png", 0);
//
//            Book book12 = new Book("978-0140449334", "Meditations", "Philosophy",
//                    "Books4Sale", 15.0, dateFormat.parse("2024-01-14"), 20.0, 25.0, "Marcus Aurelius", 4, "images/meditions.png", 0);
//
//            Book book13 = new Book("978-0553213690", "Metamorphosis", "Fiction",
//                    "Libra me shumice", 10.0, dateFormat.parse("2024-01-14"), 12.0, 18.0, "Franz Kafka", 5, "images/metamorphosis.png", 0);
//
//            Book book14 = new Book("978-0375702242", "The Idiot", "Fiction",
//                    "Book", 14.0,dateFormat.parse("2024-01-14"), 16.0, 22.0, "Fyodor Dostoevsky", 5, "images/theidiot.png", 0);
//
//            Book book15 = new Book("978-0374528379", "The Brothers Karamazov", "Fiction",
//                    "Adrion", 20.0, dateFormat.parse("2024-01-14"), 25.0, 32.0, "Fyodor Dostoevsky", 5, "images/thebrotherskaramazov.png", 0);
//
//            Book book16 = new Book("978-0747532743", "Harry Potter and the Philosopher's Stone", "Fantasy",
//                    "Adrion", 25.0, dateFormat.parse("2024-01-14"), 30.0, 40.0, "J.K. Rowling", 5, "images/harrypoter1.png", 0);
//
//            Book book17 = new Book("978-0747538493", "Harry Potter and the Chamber of Secrets", "Fantasy",
//                    "Adrion", 25.0, dateFormat.parse("2024-01-14"), 30.0, 40.0, "J.K. Rowling", 5, "images/harrypoter2.png", 0);
//
//            Book book18 = new Book("978-0747546290", "Harry Potter and the Prisoner of Azkaban", "Fantasy",
//                    "Adrion", 25.0,dateFormat.parse("2024-01-14") , 30.0, 40.0, "J.K. Rowling", 5, "images/harrypoter3.png", 0);
//
//
//
