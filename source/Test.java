        ...
        Methods mthd = new Methods();
         ...
         try {
            ...
            Book book4 = new Book("978-0061120084", "To Kill a Mockingbird", "Classic Fiction",
                    "Page Turner Books", 12.0, dateFormat.parse("2022-05-05"), 15.0, 20.0, "Harper Lee", 5,"images/To_Kill_A_Mockingbird.jpeg");
Book book5 = new Book("978-1234567890","The Divine Comedy","Italian",
        "Adrion Ltd",30.0,dateFormat.parse("2022-11-29"),40.0,45.0,"Dante Aligheri",6,"images/dante_book.png");
      Book book6= new Book("978-1212345674","Don Kishoti","Art",
              "Libra.com",12.0,dateFormat.parse("2023-01-20"),15.0,20.0,"Servantes",3,"images/dante_book.png");
      ...
      Book book8 = new Book("978-4351409439","Shoku Zylo","Shqip",
              "Shtepia e Librit",3.0,dateFormat.parse("2022-06-10"),5.0,10.0,"Dritero Agolli",5,"images/Shoku_Zylo.png");
      Book book9 = new Book("978-9808616490","Kodi i DaVincit","Novel",
              "Book R Us",21.0,dateFormat.parse("2022-04-26"),25.0,30.0,"Dan Brown",5,"images/Kodi_i_Da_Vicit.png");
Book book10= new Book("978-123098127","Kronike ne Gure","Shqip",
        "Adrion",5.0,dateFormat.parse("2022-12-2"),7.0,10.0,"Ismail Kadare",10,"images/Kronika_ne_gure.png");
